...
namespace DemoService.UserService
{
    public class UserService : IUserService
    {
        ...
        public UserViewModel LoginAuthentication(LoginViewModel loginViewModel)
        {
            ...
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["OnBoadTaskEntitiesADO"].ConnectionString;
                ...
                using (SqlConnection con = new SqlConnection(strcon))
                {
                    using (SqlCommand cmd = new SqlCommand("GetLoginInfo", con))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@UserName", loginViewModel.Email);
                        cmd.Parameters.AddWithValue("@Password", loginViewModel.PasswordHash);
